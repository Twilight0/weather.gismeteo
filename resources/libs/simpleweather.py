...
__all__ = [
    'WeatherProperties', 'Weather', 'WebClientError', 'WebClient',
...
class WebClient(requests.Session):
    ...
    def __save_cookies(self):
        if isinstance(self.cookies, cookielib.LWPCookieJar) and self.cookies.filename:
    ...
    def SPEED(self, mps):
        ...
        if isinstance(speed, str):
            ...
            try:
                ...
                return '{0}'.format(round(float(speed)))
